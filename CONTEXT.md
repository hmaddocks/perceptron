...
**Learning rate**:
A value controlling how large a weight correction is applied per misclassified row during Training mode. Fixed at 0.10 everywhere it's used (Gate demo and Freeform Classifier) — not presenter-adjustable.
