...
//
// Behavior wiring shared across all layout variants. A variant's HTML is free
// to arrange things however it likes; it just needs elements tagged with the
// data-role attributes this controller looks for. See any variantX.js for
// the full list in context.

import { Perceptron, EPOCH_CAP, CLASS_A, CLASS_B, PRESET_SEPARABLE, PRESET_NON_SEPARABLE } from "./perceptron.js";
import { renderPlane, eventToDomain, clampToActiveRegion } from "./plane.js";
